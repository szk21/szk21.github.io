...
![](http://7fva1e.com1.z0.glb.clouddn.com/C%23%20Delegate%20And%20Event01.gif)	
...
![](http://7fva1e.com1.z0.glb.clouddn.com/C%23%20Delegate%20And%20Event02.gif)
...
委托声明原型中的Object类型的参数代表了Subject，也就是监视对象，在本例中是 

- Heater(热水器)。回调函数(比如Alarm的MakeAlert)可以通过它访问触发事件的对象(Heater)。
